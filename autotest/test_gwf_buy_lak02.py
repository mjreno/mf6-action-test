...
runs = ["buy_lak_02a", "buy_lak_02b", "buy_lak_02c", "buy_lak_02d"]
gwt_conc_list = [0.0, 35.0, 35.0, 0.0]
lak_conc_list = [0.0, 35.0, 0.0, 35.0]
...
def test_gwf_buy_lak02(idx, run, tmpdir, testbin):
